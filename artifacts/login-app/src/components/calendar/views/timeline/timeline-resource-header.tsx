...
export function TimelineResourceHeader({
  ...
  return (
    <div className="sticky top-0 z-20 flex bg-background backdrop-blur-sm">
      <div
        className="shrink-0 border-r border-border/60 px-3 py-2 text-xs font-medium text-muted-foreground"
