    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background relative overflow-hidden text-foreground">
      ...
      <div className="w-full max-w-md p-8 relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl font-medium tracking-tight text-white mb-2">{title}</h1>
        ...
        <motion.div 
          ...
          className="bg-card/50 backdrop-blur-xl border border-white/5 shadow-2xl rounded-2xl p-8"
        >
          {children}
        </motion.div>
      </div>
