    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        onEscapeKeyDown={(event) => {
          onEscapeKeyDown?.(event);
          // Let the topmost nested overlay consume Escape first.
