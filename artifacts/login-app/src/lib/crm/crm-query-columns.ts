...
export const CUSTOMER_LIST_COLUMNS =
  "id, user_id, company_id, name, email, phone, phone_e164, phone_country_iso, phone_national, phone_region_source, age, gender, notes, avatar_url, created_at, updated_at";
