...
export const LOOKUP_ENTITY_REGISTRY: LookupEntityDefinition[] = [
  ...
  {
    id: "customer_scheduling_bookings",
    labelKey: "lookups.entities.customerSchedulingBookings",
    variableName: "selected_booking",
    ...
    displayFields: [
      field("display_label", "lookups.fields.displayLabel"),
      field("service_name", "lookups.fields.serviceName"),
      field("resource_name", "lookups.fields.resourceName"),
      field("start_at", "lookups.fields.startAt"),
    ...
    outputFields: [
      ...
      outputField("service_name", "lookups.fields.serviceName"),
      outputField("resource_name", "lookups.fields.resourceName"),
      outputField("display_label", "lookups.fields.displayLabel"),
    ],
    filters: [{ id: "customer_id", labelKey: "lookups.filters.customer", type: "text" }],
  },
];
