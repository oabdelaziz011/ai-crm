...
/**
 * Reads/writes notification_queue for email channel only.
 * Does not modify queue schema or shared notification repositories.
 */
export class EmailQueueConsumer {
  constructor(private readonly client: SupabaseClient) {}

  async listPendingEmail(companyId: string, limit = 25): Promise<NotificationQueueItem[]> {
