...
import { validateDocumentExtensions } from "./validation-extension-registry";
...
export function validateWorkflowNodeConfigs(
  ...
  issues.push(...validateDocumentExtensions(document, context));
...
export function validateWorkflow(
  ...
  return mergeValidationIssues(
    ...
    validateWorkflowNodeConfigs(document, context),
  );
}
