...
| Permission RPC | Company Admin → users.view | FAIL | expected=true actual=false |
| Permission RPC | Company Admin → users.edit | FAIL | expected=true actual=false |
| Permission RPC | Company Admin → roles.view | PASS | expected=true actual=true |
| Permission RPC | Company Admin → audit_logs.view | FAIL | expected=true actual=false |
...
| Permission RPC | Finance Manager → billing.view_own | FAIL | expected=true actual=false |
| Permission RPC | Finance Manager → billing.manage_own | FAIL | expected=true actual=false |
| Permission RPC | Finance Manager → billing.contact.edit_own | FAIL | expected=true actual=false |
| Permission RPC | Finance Manager → workspace.view | FAIL | expected=true actual=false |
| Permission RPC | Support Agent → users.view | PASS | expected=false actual=false |
| Permission RPC | Support Agent → customers.view | FAIL | expected=true actual=false |
| Permission RPC | Support Agent → customers.edit | FAIL | expected=true actual=false |
| Permission RPC | Support Agent → ai_chat.view | FAIL | expected=true actual=false |
| Permission RPC | Support Agent → ai_chat.use | FAIL | expected=true actual=false |
| Permission RPC | Support Agent → bookings.view | FAIL | expected=true actual=false |
| Permission RPC | Support Agent → billing.view_own | FAIL | expected=true actual=false |
| Permission RPC | Sales Manager → customers.view | FAIL | expected=true actual=false |
| Permission RPC | Sales Manager → customers.create | FAIL | expected=true actual=false |
| Permission RPC | Sales Manager → bookings.create | FAIL | expected=true actual=false |
| Permission RPC | Sales Manager → invoices.view | FAIL | expected=true actual=false |
| Permission RPC | Sales Manager → reports.view | FAIL | expected=true actual=false |
| Permission RPC | Sales Manager → workspace.view | FAIL | expected=true actual=false |
...
| RLS | Employee audit_logs SELECT denied | FAIL | canceling statement due to statement timeout |
| RLS | Company Admin audit_logs SELECT allowed | FAIL | canceling statement due to statement timeout |
