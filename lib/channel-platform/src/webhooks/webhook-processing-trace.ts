export type WebhookProcessingStep =
  ...
  | "webhook.ai_employee_email_commercial"
  | "webhook.ai_employee_email_skipped"
  | "webhook.ai_employee_email_usage"
  | "webhook.inbound_automation_gate"
  | "webhook.inbound_automation_skipped"
  | "webhook.inbound_automation_gate_error"
  | "webhook.ai_employee_engagement_started"
  | "webhook.ai_employee_intent_transfer"
  | "webhook.interactive_reply_dedupe_bypassed"
  | "webhook.interactive_reply_deduped"
  | "webhook.sticky_workflow_cleared"
  | "webhook.booking_intent_no_transfer_flow"
  | "webhook.inbound_runtime_retry_skipped"
  | "webhook.whatsapp_deterministic_welcome_sent"
  | "webhook.whatsapp_deterministic_welcome_failed"
  | "webhook.whatsapp_deterministic_welcome_stamped_after_dispatch_error"
  | "webhook.whatsapp_deterministic_welcome_skip_ai"
  | "webhook.email_routing_commercial"
  | "webhook.email_routing_usage"
