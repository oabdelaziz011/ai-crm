/**
 * Apply ONLY migration 360 (SMS as a marketing campaign channel).
 * Does NOT use supabase db push. Does NOT send campaigns or mutate recipients.
 *
 * Run: node scripts/apply-360-marketing-campaigns-sms-channel.mjs
 */
...
const migrationName = "360_marketing_campaigns_sms_channel.sql";
const version = "360";
