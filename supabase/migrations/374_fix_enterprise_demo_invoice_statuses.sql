-- ============================================================
-- 374 — Fix enterprise demo CRM invoice statuses for post-158 schema
--
-- seed_enterprise_demo_v1() still inserted legacy Title-Case statuses
-- (Paid/Unpaid/Overdue) from migration 102. Migration 158 replaced
-- public.invoices_status_check with lowercase canonical values and
-- mapped: Paid->paid, Unpaid->issued, Overdue->issued.
--
-- Append-only CREATE OR REPLACE preserves the full seed body and only
-- corrects those three literals. Does NOT call the seed (runs in seed phase).
-- Does NOT widen invoices_status_check.
-- ============================================================
...
begin
  ...
  insert into public.invoices (id, user_id, customer_id, amount, status, invoice_date, invoice_type) values
    ...
    ('d00000f0-0001-4001-8001-000000000002'::uuid, v_beta_admin, 'd00000d0-0001-4001-8001-000000000001'::uuid, 2500, 'issued', v_now - interval '2 days', 'customer'),
    ('d00000f0-0001-4001-8001-000000000003'::uuid, v_beta_admin, 'd00000d0-0001-4001-8001-000000000006'::uuid, 800, 'issued', v_now - interval '45 days', 'customer')
